...
const CallToActionSection: React.FC<CallToActionSectionProps> = memo(({ className = "" }) => {
  const whatsappNumber = ""; // Replace with actual number
  ...
  return (
    <>
        ...
        <div className="relative max-w-7xl mx-auto px-6">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-8 relative z-10 order-1 lg:order-2">
              ...
              {/* WhatsApp CTA Button (kept as-is) */}
              <div className="mt-8">
                <button
                  ref={btnRef}
      ...
      <a
        href={`https://wa.me/${whatsappNumber.replace(/\s+/g, "")}?text=${whatsappMessage}`}
        target="_blank"
        ...
        className="
          ...
          mb-4 mr-4 sm:mb-6 sm:mr-6
          inline-flex items-center justify-center
          w-14 h-14 rounded-full
          bg-green-500 hover:bg-green-600
          shadow-lg shadow-green-500/30
          ring-4 ring-white/0 hover:ring-green-300/40
